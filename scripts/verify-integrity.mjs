...
fileContains('src/js/features/user-profile.js', '/api/ai-nickname', failures, 'Security routing');
fileContains('src/js/features/essay.js', '/api/ai-essay-grade', failures, 'Security routing');
